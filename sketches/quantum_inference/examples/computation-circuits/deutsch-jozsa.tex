    ...
    \begin{figure}
        \begin{center}
            ...
            \begin{tikzpicture}[scale=0.35,thick]
                ...
                \node[anchor=center] (text) at (1,3.75) {\corelabelsize $\basqstateof{\exformula}$};
            ...
            \end{tikzpicture}
        \end{center}
        \caption{Measurement setup for the Deutsch-Jozsa test on the formula $\exformula$.
        ...
        This is equal to a scaled and squared contraction of the basis encoding to the formula $\exformula$.
