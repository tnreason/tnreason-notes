\begin{example}[Toy Accounting Example]
    ...
    \end{align*}
    Any elementary \ComputationActivationNetwork{}
    ...
    \begin{figure}[t]
        \begin{center}
            ...
            \end{tikzpicture}
        \end{center}
        \caption{Circuit to sample from the \ComputationActivationNetwork{} in the toy accounting \exaref{exa:toyAccounting}.}\label{fig:toyAccounting}
    \end{figure}
\end{example}