...
\subsubsection{Relation with basis encodings}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz_pics/function_encoding/bencoding_computation_circuit}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{tikz_pics/function_encoding/decomposition_sparsity}
    \end{center}
    \caption{
...
\begin{lemma}\label{lem:comCircuitCommutative}
    The composition of two \computationCircuits{} to functions $\exfunction$ and $\secexfunction$ (see \figref{fig:mod2ComputationCircuit}), where the \computationCircuits{} share the head qubit, is the \computationCircuit{} of their sum mod2.
    In particular, the \computationCircuits{} commute.
\end{lemma}
\begin{proof}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz_pics/function_encoding/mod2_sum_computation_circuit}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{tikz_pics/function_encoding/slice_computation_circuit}
    \end{center}
    \caption{
...
\begin{figure}[t]
    \begin{center}
        \input{tikz_pics/function_encoding/bas_sign_qstate_construction}
    \end{center}
