...
\begin{definition}[\ActivationCircuit{}]
    ...
    \begin{align*}
        ...
        \otimes \yrotationofat{h(\exformulaat{\headindexof{[\seldim]}})}{\avariableof{\insymbol},\avariableof{\outsymbol}} \, .
    \end{align*}
\end{definition}
...
\begin{align*}
    \exformulaat{\headindexof{[\seldim]}} = \frac{\hypercoreat{\headvariables=\headindexof{[\seldim]}}}{\max_{\secheadindexof{[\seldim]}} \hypercoreat{\headvariables=\secheadindexof{[\seldim]}}}
\end{align*}
...
\begin{figure}[t]
    \begin{center}
        \input{./tikz_pics/bencoding_computation_circuit}
    \end{center}
    \caption{Equivalence of computation circuit and basis encodings.}\label{fig:bencComCircuit}
\end{figure}
...
\begin{figure}[t]
    \begin{center}
        \input{./tikz_pics/bas_sign_qstate_construction}
    \end{center}
