...
\begin{align*}
    \anaugmentationofat{\hypercoreof{\edge},\acceptanceprobof{\edge}}{\avariable,\catvariableof{\edge}}
    =    %\frac{1}{\prod_{\catenumeratorin}\catdimof{\catenumerator}}
    ...
    \Big) \, .
\end{align*}
where the optimal local acceptance rates are
\begin{align*}
...
\begin{proof}
    ...
    \begin{align*}
        \acceptanceprob 
        = \prod_{\edgein}\acceptanceprobof{\edge}
