...
\begin{lemma}
    ...
    We build the concatenation of activation circuits to each tensor $\hypercoreofat{\edge}{\catvariableof{\edge}}$, where each has a distinct ancilla qubit $\avariableof{\edge}$.
    Then the concatenation acting on the state
    \begin{align*}
