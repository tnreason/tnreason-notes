\begin{tikzpicture}[scale=0.35, thick] % , baseline = -3.5pt
    ...
    %% Statistic Qubits
    \node[anchor=center] (text) at (-1,9) {\colorlabelsize $\headvariableof{\exformula,\insymbol}$};
    \node[anchor=center] (text) at (12,9) {\colorlabelsize $\headvariableof{\exformula,\outsymbol}$};
