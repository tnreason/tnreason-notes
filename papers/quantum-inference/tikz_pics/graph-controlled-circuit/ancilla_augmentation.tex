\begin{tikzpicture}[scale=0.35,thick] % , baseline = -3.5pt
    ...
    [shift={(31,-7)}]
        ...
        \node[anchor=center] (text) at (-1,6.5) {\colorlabelsize $\cavariable{\insymbol}$};
        \node[anchor=center] (text) at (12,6.5) {\colorlabelsize $\cavariable{\outsymbol}$};
    ...
    \node[anchor=center] (text) at (4.5,-2.5) {\corelabelsize $\anaugmentationof{\probtensor}$};
    ...
    \begin{scope}[shift={(3,2)}]
        ...
        \node[anchor=center] (text) at (15,-2.5) {\corelabelsize
        $\begin{bmatrix}
