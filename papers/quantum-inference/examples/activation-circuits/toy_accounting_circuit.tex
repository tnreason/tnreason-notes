\begin{example}[Toy Accounting Example]
    ...
    The second statistic has the Reed-Muller expansion
    \begin{align*}
    ...
    \begin{figure}[t]
        ...
        Note that a first Pauli-X gate $\paulixsymbol$ acting on $\catvariableof{A2}$ can be omitted, since the prepared stated is the Hadamard basis vector $\hplusbasat{\catvariableof{A2}}$.
        }
