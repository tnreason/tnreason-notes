\begin{example}[Minterm formulas]
    ...
    \begin{align*}
        \cardof{\left\{\shortcatindicesin \wcols \basemeasureat{\indexedshortcatvariables}\neq 0\right\}}-1 \, ,
    \end{align*}
    that is the set \red{did not introduce EL notation?}
    \begin{align*}
    ...
    % 
    More general the mean polytope is a standard simplex, if and only if each formula contradicts all others, that is 
    \begin{align*}
