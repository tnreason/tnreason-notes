\begin{example}[$\ttformat$ representation of diagonal faces]
    ...
    \begin{align*}
        ...
        = \contractionof{\{\hypercoreofat{0}{\headvariableof{0},\decvariableof{0}},\hypercoreofat{\seldim-1}{\decvariableof{\seldim-1},\headvariableof{\seldim-1}}\}\cup\{\hypercoreofat{\selindex}{\decvariableof{\selindex-1},\headvariableof{\selindex},\decvariableof{\selindex}}\wcols\selindex\in\{1,\ldots,\seldim-2\}\}}{\headvariables} \, .
    \end{align*}
