\begin{example}[Simplices]
    ...
    where the faces are
    \begin{align*}
        \facesymbolof{\variableset}
        = \convhullof{\onehotmapofat{\selindex}{\selvariable} \wcols\selindex\in\variableset}
    \end{align*}
...
%    \begin{align*}
%        \facesymbolof{\variableset}
%    = \meansetof{\triangle,\seldim-1} \cap \facesymbolof{[\seldim]/\variableset,0_{[\seldim]/\variableset}}
%    \end{align*}
