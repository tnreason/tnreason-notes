...
The mean polytope is the set of possible mean parameters given a by base measure representable distribution in $\distmeasuredby{\basemeasure}$.
We define it as
\begin{align*}
    \genmeanset
...
The set $\facelatticeof{\genmeanset}$, which is partially ordered by the inclusion operation, is a lattice \cite{ziegler_lectures_2013}.
