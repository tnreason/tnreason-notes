...
%\begin{align*}
%    \sencsstatat{\shortcatvariables,\indexedselvariable}
%    = \sstatcoordinateofat{\selindex}{\shortcatvariables} \, .
%\end{align*}
We define it as
\begin{align*}
    \genmeanset
...
\begin{example}[Vertices]
    ...
    Vertices $\facesymbol$ are proper faces of affine dimension $0$, that is they consist in single vectors.
    ...
    \begin{align*}
        \facesymbol = \{\sencsstatat{\indexedshortcatvariables,\selvariable}\} \, .
    \end{align*}
...
\begin{proof}
    ...
    If $\meanparam\notin\sbinteriorof{\facesymbol}$, then there is a face $\facesymbolof{\tilde{\facesymbol}}\subset\facesymbol$ of smaller affine dimension such that $\meanparam\in\facesymbol$.
    When continuing this process we reach a face such that $\meanparam\notin\sbinteriorof{\facesymbol}$, since the faces with affine dimension $0$ are vertices and they coincide with their relative interior because they contain a single vector.
\end{proof}
