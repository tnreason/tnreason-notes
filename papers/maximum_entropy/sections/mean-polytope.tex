...
The set $\facelatticeof{\genmeanset}$ is partially ordered by the inclusion operation and is called a lattice \cite{ziegler_lectures_2013}.
...
To this end, we use the $\cpformat$ format describing tensor networks on the $\cpformat$ hypergraph
\begin{align*}
    \cpformat
