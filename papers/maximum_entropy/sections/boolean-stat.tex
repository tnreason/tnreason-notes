...
\begin{figure}
    ...
    \caption{$\ttformat$ format consisting in th $\ttformat$ hypergraph a) and decorating tensor networks b).}\label{fig:ttFormat}
\end{figure}

%% Order?

We further present examples of faces in a $\ttformat$ format representation.
...
%\input{examples/boolean-stat/tt-diagonal-higher-face}
%\input{examples/boolean-stat/unused-ht-diagonal-face}
