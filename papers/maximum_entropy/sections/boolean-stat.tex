...
\theref{the:faceMeasureHardLogicNetworks} implices that hypercubes (see \exaref{exa:hypercubeFaces}) and simplices (see \exaref{exa:simplexFaces}) are cube-like polytopes, since their faces are intersections with faces of the hypercube.
