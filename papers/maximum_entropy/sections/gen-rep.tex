...
\begin{align*}
    ...
    \{\probof{\sstat,\meanparam,\basemeasure} \wcols \meanparam\in\genmeanset\ncond \probof{\sstat,\meanparam,\basemeasure} \quad\text{is a solution of \problemref{prob:maxEntropy}} \} \, .
\end{align*}

By \theref{the:expFamilyTensorRep} the maximum entropy distributions have a parameterization by
\begin{align*}
    \gencanparamset
...
\begin{align*}
    \maxentfamilyof{\sstat}{\basemeasure} =
    \{\normalizationof{\softacttensorat{\headvariables},\kcoreofat{\facesymbol}{\headvariables},\bencsstatwith,\basemeasurewith}{\shortcatvariables}
