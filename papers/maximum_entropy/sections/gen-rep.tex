...
\begin{align*}
    ...
    \{\probof{\sstat,\meanparam,\basemeasure} \wcols \meanparam\in\genmeanset\ncond \probof{\sstat,\meanparam,\basemeasure} \quad\text{is a solution of \probref{prob:maxEntropy}} \} \, .
\end{align*}

By \theref{the:expFamilyTensorRep} this is the union of exponential families to each face measure, that is
\begin{align*}
    \maxentfamilyof{\sstat}{\basemeasure} =
    ...
    \wcols \canparamwithin\ncond \facesymbol\in\facelatticeof{\genmeanset}\}
\end{align*}
