...
%    where $\acttensorwith$ is an arbitrary non-negative tensor.
    ...
    \end{align*}
    Therefore, for any activation tensor $\acttensorwith$ we obtain
    \begin{align*}
        \probwith
    ...
    \end{align*}
    Put differently, in the graphical–model case the activation tensor coincides with the joint distribution tensor.
