\begin{example}[Sufficient statistics for the probability]\label{exa:sufStatProb}
    ...
    \begin{align*}
        \condprobof{\indexedshortcatvariables}{\headvariableof{\sstat}=\headindex} =
        \begin{cases}
    ...
    \end{align*}
    %% Explanation
    When knowing the value $\sstatat{\shortcatindices}$ of the sufficient statistic at a given index $\shortcatindices$, we then also know the probability $\probat{\indexedshortcatvariables}$.
