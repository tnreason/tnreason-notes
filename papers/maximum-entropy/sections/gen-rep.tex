...
\begin{lemma}
    ...
    For any $\meanparamwith\in\genmeanset$ and a face $\facein$ with $\meanparamwith\in\sbinteriorof{\facesymbol}$ the solution of $\mathrm{P}_{\sstat,\meanparam,\basemeasure}$ and $\mathrm{P}_{\sstat,\meanparam,\genfacemeasure}$ coincides.
\end{lemma}
\begin{proof}
