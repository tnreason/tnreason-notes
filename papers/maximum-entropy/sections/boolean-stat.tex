...
% Theorem intro
We can further show, that in case of Boolean statistics any distribution in $\realizabledistsof{\hlnstat,\elgraph,\basemeasure}$ is a maximum entropy distribution.
