...
\begin{itemize}
    ...
    \begin{align*}
        \reflectionofat{\goodstatesymbol}{\avariables^{\insymbol},\avariables^{\outsymbol}}
        = \identityat{\avariables^{\insymbol},\avariables^{\outsymbol}}
        - 2 \onehotmapofat{1_{[\seldim]}}{\avariables^{\insymbol}} \otimes \onehotmapofat{1_{[\seldim]}}{\avariables^{\outsymbol}}
    \end{align*}
    \item Reflection along $\qstate$, by
    \begin{align*}
        \reflectionofat{\qstate}{\avariables^{\insymbol},\headvariables^{\insymbol},\avariables^{\insymbol},\avariables^{\outsymbol},\headvariables^{\outsymbol},\avariables^{\outsymbol}}
        =& \identityat{\avariables^{\insymbol},\headvariables^{\insymbol},\avariables^{\insymbol},\avariables^{\outsymbol},\headvariables^{\outsymbol},\avariables^{\outsymbol}} \\
        &- 2 \qstateofat{0}{\avariables^{\insymbol},\headvariables^{\insymbol},\shortcatvariables^{\insymbol}} \otimes
        \qstateofat{0}{\avariables^{\outsymbol},\headvariables^{\outsymbol},\shortcatvariables^{\outsymbol}}
        %U (\identityat{\avariables^{\insymbol},\avariables^{\outsymbol}} - 2 \onehotmapofat{1_{[\seldim]}}{\avariables^{\insymbol}} \otimes \onehotmapofat{1_{[\seldim]}}{\avariables^{\outsymbol}}) U^T
    \end{align*}
