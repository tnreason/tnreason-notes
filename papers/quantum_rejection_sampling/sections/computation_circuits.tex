...
More precisely, we construct sparse circuoits preparing q-samples to the normalized computation network
\begin{align*}
...
\red{These are called mixed polarity Reed-Muller expanions.}
