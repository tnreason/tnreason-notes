...
\begin{lemma}
    ...
    \begin{align*}
        \qcbencodingofat{\secexfunction\circ\exformula}{
            \cheadvariableof{\secexfunction\circ\exformula}{\insymbol},
            \headvariableof{\outsymbol,\secexfunction\circ\exformula},
            \catvariableof{[\atomorder]}}
        \otimes \fbasisat{\cheadvariableof{\exformula}{\outsymbol}}
        = \breakablecontractionof{
            &\onehotmapofat{0}{\cheadvariableof{\exformula}{\insymbol}},\\
            &\qcbencodingofat{\exformula}{\cheadvariableof{\exformula}{\insymbol},
                \cheadvariableof{\exformula}{\midsymbol},
                \catvariableof{[\atomorder]}},\\
            &\qcbencodingofat{\secexfunction}{
                \headvariableof{\insymbol,\secexfunction\circ\exformula},
                \headvariableof{\outsymbol,\secexfunction\circ\exformula},
                \cheadvariableof{\exformula}{\midsymbol}}
            &\qcbencodingofat{\exformula}{\cheadvariableof{\exformula}{\midsymbol},
                \cheadvariableof{\exformula}{\outsymbol},
                \catvariableof{[\atomorder]}},\\
        }{
            \headvariableof{\insymbol,\secexfunction\circ\exformula},\headvariableof{\outsymbol,\secexfunction\circ\exformula},\ccatvariableof{[\atomorder]}{\insymbol},\ccatvariableof{[\atomorder]}{\outsymbol}
        } \, .
    \end{align*}
\end{lemma}
\begin{proof}
...
%% Closure of
Note that to exploit \decompositionSparsity{}, we introduce another auxiliary working qubit representing the satisfaction of the sub-function $\exformula$.
...
\begin{lemma}[Phase kickback trick] % Generalize: Does not have to be uniform init state ! 
    When applying the \computationCircuit{} on the initial state
    \begin{align*}
...
\begin{align*}
     \sqrt{\frac{1}{2}} \left(\fbasisat{\headvariable} - \tbasisat{\headvariable}\right) ,  \sqrt{\frac{1}{2}} \left(\fbasisat{\headvariable} + \tbasisat{\headvariable}\right)
\end{align*}
...
\input{examples/computation-circuits/deutsch-jozsa}

\input{examples/computation-circuits/inversion-test}
