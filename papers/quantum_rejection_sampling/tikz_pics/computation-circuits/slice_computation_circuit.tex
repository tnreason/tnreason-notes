\begin{tikzpicture}[scale=0.35, thick] % , baseline = -3.5pt
    ...
    [shift={(-20,-1)}]
        ...
        \node[anchor=center] (text) at (-1,9) {\colorlabelsize $\cheadvariableof{\onehotmapof{\headindexof{\variableset}}}{\insymbol}$};
        \node[anchor=center] (text) at (12,9) {\colorlabelsize $\cheadvariableof{\onehotmapof{\headindexof{\variableset}}}{\outsymbol}$};
    ...
    \node[anchor=center] (text) at (-1,8) {\colorlabelsize $\cheadvariableof{\onehotmapof{\headindexof{\variableset}}}{\insymbol}$};
    \node[anchor=center] (text) at (12,8) {\colorlabelsize $\cheadvariableof{\onehotmapof{\headindexof{\variableset}}}{\outsymbol}$};
