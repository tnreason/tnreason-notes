...
\newcommand{\mintermformulaset}{\mathcal{F}_{\land}}
...
%% Constraints
\newcommand{\eoconword}{exactly-one constraint}

\newcommand{\exactlyonecon}{\hypercore^{=1}}
\newcommand{\exactlyoneconof}[1]{\hypercore^{=1,#1}}
\newcommand{\exactlyoneconat}[1]{\exactlyonecon[#1]}
\newcommand{\exactlyoneconofat}[2]{\exactlyoneconof{#1}[#2]}



\newcommand{\atmostonecon}{\hypercore^{\leq 1}}
\newcommand{\atmostoneconof}[1]{\hypercore^{\leq 1, #1}}
\newcommand{\atmostoneconat}[1]{\atmostonecon[#1]}
\newcommand{\atmostoneconofat}[2]{\atmostoneconof{#1}[#2]}
