...
\newcommand{\layertwospec}{\textbf{Layer 2}: Tensor methods}
\newcommand{\layerthreespec}{\textbf{Layer 3}: Models and data}

\newcommand{\qcreason}{$\mathrm{qcreason}$}
\newcommand{\curverqcreason}{0.0.0}
\newcommand{\spsimulation}{$\mathrm{simulation}$}
\newcommand{\sppreparation}{$\mathrm{preparation}$}
\newcommand{\spinference}{$\mathrm{inference}$}
...
%% Further Broad Concepts
\newcommand{\neuroSymbolicAI}{Neuro-Symbolic AI}
