\usepackage{../template/ENEXA/beamercolorthemeclaw}
\usepackage{../template/ENEXA/beamerfontthemeclaw}
\usepackage{../template//ENEXA/beamerinnerthemeclaw}
\usepackage{../template/ENEXA/beamerouterthemeclaw}
...
\begin{tikzpicture}
	\node at (11.45,0) {\includegraphics[width=0.09\paperwidth]{../template/images/wgllogo-2017-en.pdf}};
	\node at (0,0) {\includegraphics[width=0.07\paperwidth]{../template/images/wias.png}};
\end{tikzpicture}
