...
\begin{tikzpicture}
%	\node at (11.2,0) {\includegraphics[width=0.125\paperwidth]{../template/images/qrom.png}};
	\node at (0,0) {\includegraphics[width=0.08\paperwidth]{../template/images/wias.png}};
\end{tikzpicture}
