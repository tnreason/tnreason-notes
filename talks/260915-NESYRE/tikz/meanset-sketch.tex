...
%    \node[below] at ($0.5*(A)+0.5*(E)-(0,1.3)$) {$\genmeanset/\sbinteriorof{\genmeanset}$};
    ...
    \draw[fill,\concolor] (A) circle (0.25);
    \draw[fill,\concolor] (B) circle (0.25);
    \draw[fill,\concolor] (C) circle (0.25);
    \draw[fill,\concolor] (D) circle (0.25);
    \draw[fill,\concolor] (E) circle (0.25);
