...
\begin{center}
    \begin{tabular}{|c|c|c|c|}
        ...
        Pauli-X & \stringof{X} & & $\paulixat{\avariableof{\insymbol},\avariableof{\outsymbol}}$ \\
        Multiple controlled $X$ & \stringof{MCX} &  & \\
        Rotation around $Y$-axis & \stringof{MRY} & Angle $\alpha$ & $\yrotationofat{\alpha}{\avariableof{\insymbol},\avariableof{\outsymbol}}$ \\
        \hline
    \end{tabular}
\end{center}
...
% Example
For example a hadamard gate on qubit \stringof{blue} and a multiple controlled rotation around the $Y$-axis on qubit \stringof{ancilla\_c1} controlled by qubits \stringof{red} and \stringof{blue} in state $(0,1)$ with angle $0.6121442808462428$ is represented as:
\begin{minted}{python}
[{'unitary': 'H',
    'targetQubits': ['blue']},
{'unitary': 'MCRY',
