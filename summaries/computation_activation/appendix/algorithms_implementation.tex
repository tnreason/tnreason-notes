...
The three message passing algorithms are implemented as functions in a single class \mintinline{python}{ContractionPropagation}, since they share common structure.
