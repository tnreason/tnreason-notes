...
The implementations of the algorithms and concepts are available at \href{https://github.com/tnreason/nesy-demonstrations/}{\url{https://github.com/tnreason/nesy-demonstrations/}} and implemented with \tnreason{} in the version \curvertnreason{}.
...
\inputminted{python}{../implementation/propagation.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/propagation.py}
...
\inputminted{python}{../implementation/m_adic_sum.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/m_adic_sum.py}
...
\inputminted{python}{../implementation/student.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/student.py}
...
\inputminted{python}{../implementation/sudoku.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/sudoku.py}
...
\inputminted{python}{../implementation/moment_matching.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/moment_matching.py}
...
\inputminted{python}{../implementation/accounting.py}
% \inputminted{python}{summaries/computation_activation/wias_preprint/implementation/accounting.py}
