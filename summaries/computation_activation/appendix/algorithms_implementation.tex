...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/propagation.py}
...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/m_adic_sum.py}
...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/student.py}
...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/sudoku.py}
...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/moment_matching.py}
...
% \inputminted{python}{summaries/computation_activation/wias_preprint/algs/accounting.py}
