...
We first, introduce the basic architecture and later show how the probabilistic and logical framework are covered.
This is done in multiple steps.
First, the considered variables and tensors are explained. Followed by the explanation of tensor calculations, mainly tensor products and contractions.
...
%\janina{Example graph and definition}

\input{../examples/tt_format.tex}

\input{../examples/cp_format.tex}
...
\subsection{Directed Tensors and Normalizations}
...
\begin{definition}[Basis encoding of maps between state sets]
    ...
    \end{align*}
\end{definition}
Basis encodings are directed tensors and are thus depicted as decorations of directed edges in hypergraphs:
\begin{center}
