...
\input{../examples/prop_formula_coordinatewise.tex}
...
\input{../examples/prop_formula_basCP.tex}
...
\begin{lemma}\label{lem:formulaDecomp}
...
\input{../examples/sudoku_entailment}
...
\input{../examples/prop_formula_kb_head_sym}
...
\begin{theorem}[Monotonicity of Propositional Logics]\label{the:monotonicityPL}
...
\begin{theorem}[Invariance of adding Entailed Formulas]\label{the:addingEntailed}
...
\end{theorem}
\begin{proof}
    We use that $\formula[\shortcatvariables]+\lnot\formula[\shortcatvariables]=\onesat{\shortcatvariables}$ and thus
    \begin{align*}
        \kbwith
        &= \contractionof{\kb[\shortcatvariables],(\formula[\shortcatvariables]+\lnot\formula[\shortcatvariables])}{\shortcatvariables} \\
        &= \contractionof{\kb[\shortcatvariables],\formula[\shortcatvariables]}{\shortcatvariables}  + \contractionof{\kb[\shortcatvariables],\lnot\formula[\shortcatvariables]}{\shortcatvariables}  \\
        &= \contractionof{\kb[\shortcatvariables],\formula[\shortcatvariables]}{\shortcatvariables} \, .
    \end{align*}
\end{proof}


One can understand this theorem as "making the knowledge base more accessible":
...
\input{../examples/sudoku_message_passing.tex}
