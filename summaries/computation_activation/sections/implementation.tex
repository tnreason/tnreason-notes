...
In the subpackage \tnreason{}.\spreasoning{} we implement reasoning algorithms, such as generalization of the message passing algorithms presented in \algoref{alg:treeBeliefPropagation}, \algoref{alg:constraintPropagation} and \algoref{alg:AMM_HLN}.
...
We can for example check whether \mintinline{python}{{"X_0":0,"X_1":1,"X_2"}} is a model:
\begin{minted}{python}
