...
\end{minted}
Here we apply a nested-list description of syntactic hypergraphs (see \defref{def:formulaDecomposition}) with a specification of the logical connectives in the first position of the list (by \mintinline{python}{"and","or","not"} we refer to the connectives $\land,\lor,\lnot$).
