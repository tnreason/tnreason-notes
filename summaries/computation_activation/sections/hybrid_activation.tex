...
Let us now demonstrate a further usage of our unified treatment of probabilistic and logical models, by investigating a generalized concept of entailment.
...
\begin{theorem}\label{the:hybridEntailment}
    ...
    Then we have the probabilistic entailment of $\secexformula$ by $\probof{\hlnparameters}$, that is
    \begin{align*}
