...
\end{align*}
Based on an interpretation of the coordinate descent steps as matching steps for the mean parameters (moments) to $\formulaof{\selindex}$, we call this method alternating moment matching for \HybridLogicNetworks{} and provide pseudocode for it in \algoref{alg:AMM_HLN}.
