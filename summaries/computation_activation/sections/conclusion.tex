...
The \CompActNets{} framework enables both the symbolic logical and probabilistic models, but enables also the representation of generic functions.
\CompActNets{} based on architectures combining both symbolically verbalizable and more generic neural parts are thus a promising candidate for Neuro-Symbolic AI.
