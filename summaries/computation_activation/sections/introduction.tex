...
%     % \item \martin{ensure all sections and subsections have at least one sentence intro.} \janina{Looks done.}
%     \item \martin{the use of capital letters for certain terms is inconsistent.} \alex{Should be fine now, i went through sections, theorems, examples. Are there further inconsistencies?} \janina{Should we write neuro-symbolic AI? Anke just asked, when checking out the WIAS preprint title.}
% \end{itemize}
...
These auxiliary variables represent logical formulas or more generic statistics in different contexts.
...
%% History of TN
Historically rooted in quantum many-body physics ~\cite{white_density-matrix_1993}, tensor networks found their first major success with Matrix Product States (MPS), originally developed to efficiently capture the quantum dynamics and ground states of one-dimensional spin chains ~\cite{affleck_rigorous_1987}.
...
Beyond the quantum realm, these formats have been successfully adapted to applied mathematics, particularly for solving high-dimensional parametric PDEs~\cite{eigel_variational_2019,eigel_adaptive_2020,dolgov_hybrid_2019,dolgov_polynomial_2015,trunschke_weighted_2025}, sampling problems and approximation of the Hamilton-Jacobi-Belman equation~\cite{gruhlke_reverse_2026,eigel_dynamical_2023,dolgov_data-driven_2023,cui_deep_2022}, modeling complex continuous fields and learning dynamical laws~\cite{hagemann_sampling_2025, eigel_adaptive_2017, goessmann_tensor_2020, lubich_dynamical_2013}.
...
Furthermore, the MeLoCoToN approach \cite{ali_explicit_2025} applies tensor network architectures similar to \CompActNets{} in combinatorial optimization problems.
...
Section~\ref{sec:neurPar} is dedicated to the \emph{neural paradigm}, where we show that generic function decompositions have analogous tensor network representations.
