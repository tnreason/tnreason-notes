...
\begin{itemize}
    ...
    \item \martin{the use of capital letters for certain terms is inconsistent.} \alex{Should be fine now, i went through sections, theorems, examples. Are there further inconsistencies?}
\end{itemize}
