...
The activation tensor $\acttensorat{\headvariables,\indexedthirdcatvariable}$, which decomposition is called the \emph{activation network}, is specific to each member of the family.
