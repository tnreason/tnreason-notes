...
Let us now show, that exponential families are specific instances of \CompActNets{}, which activation tensors have elementary decompositions.
...
\begin{algorithm}[hbt!]
    ...
    \begin{algorithmic}
        ...
        \iosepline
        \State Initialize $\scheduler=\{(\secsedge,\sedge) \wcols \secsedge \quad\text{a leaf in } (\edges,\dirovedges)\}]$
