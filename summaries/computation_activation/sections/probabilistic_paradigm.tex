...
To se that \defref{def:expFamily} is consistent with the typical definition of exponential families (see \cite{brown_fundamentals_1987}), let us notice that for each $\canparamin$ the normalization amounts to the division by
\begin{align*}
...
\end{align*}
a quantity which is refered to as the partition function.
