...
To see that \defref{def:expFamily} is consistent with the typical definition of exponential families (see \cite{brown_fundamentals_1987}), let us notice that for each $\canparamin$ the normalization amounts to the division by
\begin{align*}
...
\begin{theorem}
    ...
    \begin{align*}
        ...
        =\contractionof{\{\hypercoreofat{\sedge}{\catvariableof{\sedge}}\}\cup
            \{\mesfromtowith{\secsedge}{\sedge} \wcols (\secsedge,\sedge)\in\dirovedges\}}{\catvariableof{\edge}\janina{X_{e_0}?}} \, .
    \end{align*}
\end{theorem}
