...
The following theorem states that the contraction of a whole tensor network can be replaced by local contractions with derived messages.
Since contracting the whole network can be infeasible, this shows that the message passing algorithm can be advantageous.
...
\begin{proof}
    ...
    Notie that since always $\sedge\in\preedgeset$ we have that $n\geq1$.
