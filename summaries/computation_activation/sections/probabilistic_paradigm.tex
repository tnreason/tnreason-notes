...
We here investigate message passing algorithms, which decompose global contractions into a sequence of local contractions, which results are passed as messages through the tensor network.
