...
\begin{corollary}
    ...
    Then, there is a tensor $\basemeasurewith$ and an activation tensors $\acttensorat{\headvariables,\thirdcatvariable}$ such that for any $\thirdcatindex\in\mathrm{val}(\thirdcatvariable)$ we have
    \begin{align*}
...
\begin{proof}[Proof of \theref{the:treeBeliefPropagationExactness}]
    ...
    \end{align*}
    were we used \lemref{lem:messageAsContraction} in the second equation.
\end{proof}
