...
\begin{definition}[Syntactical Decompositions]\label{def:syntacticalDecomposition}
...
\begin{theorem}
    ...
    All messages during constraint propagation are sound, i.e
    \begin{align*}
...
\begin{proof}
    ...
    \begin{align}\label{eq:nzMessageAddingEquivalence}
