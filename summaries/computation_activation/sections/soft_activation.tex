...
\alex{Contractions of tensor networks are in generality hard to solve.
...
The resulting algorithm is called Belief Propagation \algoref{alg:beliefPropagation}.
