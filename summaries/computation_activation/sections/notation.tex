...
\begin{align*}
    \bencodingofat{\exfunction}{\headvariable,\catvariable}
    = \sum_{\arbelement\in\inset} \onehotmapofat{\invindexinterpretationofat{\outsymbol}{\exfunction(\arbelement)}}{\headvariable}
    \otimes \onehotmapofat{\invindexinterpretationofat{\insymbol}{\arbelement}}{\catvariable} \, ,
\end{align*}
...
Any \CompActNet{} is represntable with respect to the maximal hypergraph
\begin{align*}
    \maxgraph  = \big(\nodes,\{\nodes\}\big) \, .
\end{align*}
