\begin{example}[Continuation of \exaref{exa:hlnAccountingAMM}]
    Consider again the \HybridLogicNetwork{} $\probof{(\catvariableof{A1}\oplus\catvariableof{A2},\catvariableof{F}\Rightarrow\catvariableof{A1}),\big(\{0\},(1),(0,\lnof{3})\big)}$ from \exaref{exa:hlnAccountingAMM} and assume we want to decide the probabilistic entailment of the formula
    \begin{align*}
