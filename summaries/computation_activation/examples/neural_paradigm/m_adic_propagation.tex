\begin{example}[Continuation of \exaref{exa:madicRepresentation}]%[Computation of the sum of $\catdim$-adic integers]
    ...
    Let us now show how \algoref{alg:directedBeliefPropagation} can be exploited to compute by an efficient message passing algorithm for the digits of the $\catdim$-adic sum.
