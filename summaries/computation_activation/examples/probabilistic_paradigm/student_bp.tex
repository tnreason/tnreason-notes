\begin{example}[Continuation of \exaref{exa:studentHC}]
    \label{exa:studentBP}
    Let us now exemplify the Belief Propagation \algoref{alg:treeBeliefPropagation} on the Markov Network in the student example (see \exaref{exa:studentHC}).
    ...
    \end{itemize}
    In this implementation \algoref{alg:treeBeliefPropagation} terminates after $\cardof{\dirovedges}=4$ iterations of the $\mathrm{While}$ loop.
