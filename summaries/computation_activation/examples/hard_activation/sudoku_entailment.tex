\begin{example}[$n^2\,\times \,n^2$ Sudoku]
    ...
    \begin{align*}
        \kb^{n}  \coloneqq
        &\left( \bigwedge_{r0,r1,c0,c1\in[n]} \left( \woneoplus_{i\in[n^2]} \catvariableof{r0,r1,c0,c1,i} \right) \right) \land
...
%    \begin{itemize}
%        \item Nodes labeled by $n^6$ tuples $(r0,r1,c0,c1,i)$:
%        \begin{align*}
%            \nodes = \{(r0,r1,c0,c1,i) \wcols r0,r1,c0,c1 \in [n]\ncond i \in [n^2]\}
%        \end{align*}
%        \item Hyperedges by the $4\cdot n^4$ constraints (implementing the position, row, columns and square contraints):
%        \begin{align*}
%            \edges =& \big\{\{(r0,r1,c0,c1,i) \wcols r0,r1,c0,c1\in[n]\} \wcols r0,r1,c0,c1\in[n]\big\} \cup \\
%            &\big\{\{(r0,r1,c0,c1,i) \wcols r0,r1,c0,c1\in[n]\} \wcols r0,r1\in[n], i\in[n^2]\big\} \cup \\
%            &\big\{\{(r0,r1,c0,c1,i) \wcols r0,r1,c0,c1\in[n]\} \wcols c0,c1\in[n], i\in[n^2]\big\} \cup \\
%            &\big\{\{(r0,r1,c0,c1,i) \wcols r0,r1,c0,c1\in[n]\} \wcols r0,c0\in[n], i\in[n^2]\big\} \cup
%        \end{align*}
%        Each hypercore is carried by a tensor representing the logical formula $\woneoplus$ on $n^2$ boolean variables.
%    \end{itemize}
    ...
    \begin{center}
        ...
        \end{sudoku4x4}
    \end{center}
    We will later demonstrate in \exaref{exa:sudokuEntailment} a solution algorithm to solve this instance, after we have derived sparse tensor network representations in \exaref{exa:sudokuDecomposition}.
\end{example}