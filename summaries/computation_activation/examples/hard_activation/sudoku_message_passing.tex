    ...
    \begin{figure}
        \begin{center}
            \begin{tikzpicture}[scale=0.35,thick]
                ...
                \node[anchor=north] (text) at (18,-10) {\colorlabelsize $\decvariableof{0,0,0,0,:}$};
            ...
            \end{tikzpicture}
        \end{center}
        \caption{Depiction of the first reasoing step by messages passed in the $\mathrm{While}$ loop of the Constraint Propagation \algoref{alg:constraintPropagation}.}\label{fig:contractionPropagationSudoku}
    \end{figure}
