\begin{example}[Sparse representation of Sudoku rule Knowledge Base]
    ...
    \begin{center}
        \begin{tikzpicture}[scale=0.35,thick]
            ...
            \draw (-7,-1)--(-7,-2.5) node[midway,right] {\colorlabelsize $\catvariableof{0,0,0,0,n^2\shortminus 1}$};
            ...
            \draw (12,-1)--(12,-2.5) node[midway,right] {\colorlabelsize $\catvariableof{0,0,0,0,n^2\shortminus1}$};
