\begin{example}[Independent Boolean Variables: Coin toss interpretation]
    \label{exa:ctHc}
    ...
    \begin{figure}
        \begin{center}
            ...
            \end{tikzpicture}
        \end{center}
        \caption{Decomposition of a probability distribution with independent variables (see \exaref{exa:ctHc}).
