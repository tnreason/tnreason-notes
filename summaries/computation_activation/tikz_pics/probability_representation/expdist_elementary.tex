\begin{tikzpicture}[scale=0.35,thick,xscale=1.2] % , baseline = -3.5pt

    \begin{scope}
    [shift={(-13,0)}]
        \draw (-2,-1) rectangle (6,-3);
        \node[anchor=center] (text) at (2,-2) {\corelabelsize $ \expdist$}; %\partitionfunctionof{\sstat,\canparam,\basemeasure} \cdot
        ...
        \node[anchor=center] (text) at (9,-2) {$= \,\,\frac{1}{\partitionfunctionof{\canparam}}\,\cdot$};
    \end{scope}
