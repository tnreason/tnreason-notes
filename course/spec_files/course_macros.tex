...
\newcommand{\setchatwotitledate}[2]{
    \title[#1]{
        \coursechaptertwo \\
        {\huge #1}
    }
...
\newcommand{\scriptrepsymbol}{s}
\newcommand{\scriptrepof}[1]{\scriptrepsymbol(#1)}

\newcommand{\pyinline}[1]{
    \mintinline{python}{#1}
}

%\newcommand{\stanpycode}[1]{
%\begin{minted}{python}
%    #1
%\end{minted}
%}
...
\tikzset{
    midarrow/.style={
        ...
        decoration={
            markings,
            mark=at position 0.6 with {\arrow{Straight Barb[length=4pt, width=5pt]}}
...
\usetikzlibrary{decorations.pathreplacing, calligraphy} % Calligraphy makes the brace look "nicer"
