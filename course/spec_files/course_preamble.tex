%% Beamer Template
\usepackage{../../spec_files/beamer_template/beamercolorthemeclaw}
\usepackage{../../spec_files/beamer_template/beamerfontthemeclaw}
\usepackage{../../spec_files/beamer_template/beamerinnerthemeclaw}
\usepackage{../../spec_files/beamer_template/beamerouterthemeclaw}
...
\usebackgroundtemplate{
    \begin{tikzpicture}
        %\node at (11.2,0) {\includegraphics[width=0.16\paperwidth]{/Users/alexgoessmann/Documents/ENEXA/latex_macros/images/enexa.png}};
        %\node at (0,0) {\includegraphics[width=0.065\paperwidth]{/Users/alexgoessmann/Documents/ENEXA/latex_macros/images/DATEV.png}};
    \end{tikzpicture}
