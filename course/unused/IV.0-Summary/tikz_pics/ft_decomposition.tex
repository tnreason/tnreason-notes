...
\node[anchor=center] (text) at (1.5,-2) {\small $\bencodingof{a \land b \land \lnot c}$};
\draw[->] (1.5,-3)--(1.5,-5) node[midway,right] {\tiny ${a \land b \land \lnot c}$}; 
...
\draw[->] (1.5,-3) --(1.5,-5) node[midway,right]{\tiny ${a \land b}$};
...
\node[anchor=center] (text) at (3.5,-6) {\small $\bencodingof{\land}$};
	
\draw[->] (4,-7) -- (4,-9) node[midway,right] {\tiny ${a \land b \land \lnot c}$};
