...
\begin{scope}[shift={(-20,0)}]
	...
	\node [circle, draw, thick, fill=gray!50, minimum size = \nodeminsize] (S) at (6,3) {};
	\node[anchor=center] (text) at (6,3) {\colorlabelsize $\fselectionmap$};
...
\draw[->-] (2,1) -- (2,3) node[midway, right]  {\colorlabelsize $\catvariableof{\fselectionmap}$};
\draw[<-] (5,0) -- (7,0) node[midway, above] {\colorlabelsize $\fselectionvariable$};
