...
\draw[<-] (0,-1)--(0,1.5) node[below] {\colorlabelsize ${a}$};
\draw[<-] (1.5,-1)--(1.5,1.5) node[below] {\colorlabelsize ${b}$};
\draw[<-] (3,-1)--(3,1.5) node[below] {\colorlabelsize ${c}$};
...
\draw (0,0.5)--(0,1.5) node[below] {\colorlabelsize ${a}$};
...
\draw (3,0.5)--(3,1.5) node[below] {\colorlabelsize ${b}$};
...
\draw (6,0.5)--(6,1.5) node[below] {\colorlabelsize ${c}$};
...
\draw[->-] (1.5,-3) --(1.5,-6) node[midway,right]{\colorlabelsize ${a \lor b}$};
...
\draw[->-] (6,-3) --(6,-6) node[midway,left]{\colorlabelsize ${\lnot c}$};
...
\draw[->-] (4,-8) -- (4,-11) node[midway,right] {\colorlabelsize ${a \lor b \lor \lnot c}$};

\only<1>{
\draw[fill] (4,-11) circle (0.25cm);
\draw (4,-11) -- (2.25,-11);
\draw  (0.25, -8.5) rectangle (2.25, -11.5);
\node[anchor=center] (text) at (1.25,-10) {$\begin{bmatrix} 
1 \\
1
\end{bmatrix}$};}
...
\only<2->{
\draw[fill,\concolor] (4,-11) circle (0.25cm);
\draw[\concolor] (4,-11) -- (2.25,-11);
