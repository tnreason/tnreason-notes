...
%	\node[anchor=center] (text) at (9,0) {\colorlabelsize $\catvariableof{\atomorder\shortminus1}$};
%	
%	\node [circle, draw, thick, fill=gray!50, minimum size = \nodeminsize] (T4) at (12,0) {};
%	\node[anchor=center] (text) at (12,0) {\colorlabelsize $\cselinputvariable$};
%
%	
%	\node [circle, draw, thick, fill=gray!50, minimum size = \nodeminsize] (S) at (6,3) {};
%	\node[anchor=center] (text) at (6,3) {\colorlabelsize $\catvariableof{\cselectionsymbol}$};
%	
%	\draw[->-] (T1) -- (S);
%	\draw[->-] (T2) -- (S);
%	\draw[->-] (T3) -- (S);
...
\draw[->-] (2,1) -- (2,3) node[midway, right]  {\colorlabelsize $\catvariableof{\cselectionsymbol}$};
\draw[<-] (5,0) -- (7,0) node[midway, above] {\colorlabelsize $\cselinputvariable$};
