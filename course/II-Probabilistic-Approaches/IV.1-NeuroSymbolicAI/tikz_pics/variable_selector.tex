...
%	\node[anchor=center] (text) at (12,3) {\colorlabelsize $\vselectionvariable$};
%
%	
%	\node [circle, draw, thick, fill=gray!50, minimum size = \nodeminsize] (S) at (6,3) {};
%	\node[anchor=center] (text) at (6,3) {\colorlabelsize $\vselectionmap$};
%	
%	\draw[->-] (T1) -- (S);
%	\draw[->-] (T2) -- (S);
%	\draw[->-] (T3) -- (S);
...
\draw[->-] (2,1) -- (2,3) node[midway, right]  {\colorlabelsize $\catvariableof{\vselectionsymbol}$};
\draw[<-] (5,0) -- (7,0) node[midway, above] {\colorlabelsize $\vselectionvariable$};
...
\draw[->-] (\conposseldec) -- (4.5,3) node[midway, right]{\colorlabelsize $\vseloutputvariable$};

\draw[<-]  (0,-3) -- (0,-5);
\draw (0,-5) -- (0,-7) node[midway,left] {\colorlabelsize $\catvariableof{0}$};
\draw (-1,-1) rectangle (1, -3);
\node[anchor=center] (text) at (0,-2) {\corelabelsize $\selectorcoreof{0}$};
...
\node[anchor=center] (text) at (3,-3) {\corelabelsize $\selectorcoreof{1}$};
...
\draw[<-]  (9,-5) -- (9,-7) node[midway,left] {\colorlabelsize $\catvariableof{\seldim\shortminus1}$};
\draw (7.75,-3) rectangle (10.25, -5);
\node[anchor=center] (text) at (9,-4) {\corelabelsize $\selectorcoreof{\seldim\shortminus1}$};
\draw[] (9,-3) to[bend left=-20]  (\conposseldec);
\draw[] (10.25,-4) to[bend right=5]  (12,-1.5);

\draw[fill] (12,-1.5) circle (0.25cm);
\draw[<-] (12.25,-1.5) -- (14,-1.5) node[midway,above] {\colorlabelsize $\vselectionvariable$};
\end{scope}
