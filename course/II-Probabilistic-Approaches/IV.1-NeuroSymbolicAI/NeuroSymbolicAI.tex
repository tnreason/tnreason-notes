...
\begin{frame}{Hochreiter: Towards a Broad AI}
 {\corelabelsize Communications of the ACM, April 2022}
...
\begin{frame}{Generation processes by deep layers}
	\begin{center}
		...
		{\corelabelsize Lin, Tegmark, Rolnick: Why does deep and cheap learning work so well? \\
