...
\title[Neuro-Symbolic AI]{
    \coursechapterone \\
    {\huge Introduction into Neuro-Symbolic AI}
}
...
{\frame[plain]{\titlepage}}
    ...
    \section{LLMs: Where are they good at, where do they need to improve?}
...
%\end{itemize}
    ...
    \section{The \tnreason{} initiative}
...
%    \end{frame}
    ...
    \begin{frame}{Explainable AI}
        ...
        \tnreason{} is concerned with \textbf{intrinsic and ante-hoc} explainable models:
        \begin{itemize}
    ...
    \begin{frame}{Causal AI}
        ...
        With \tnreason{} we go one step beyond and represent cause and effect relationships in terms of probabilistic logics.
...
%	ENEXA methods have a rich mathematical structure, enabling tackling Explainable- Neuro-Symbolic and Causal AI
    ...
    \begin{frame}{Research topics}
        Efficiency of contractions is key
        \begin{itemize}
            \item Current work: Efficient reasoning schemes orchestrated by LLMs
            \item Improvement of efficiency using Quantum Computing
        \end{itemize}
