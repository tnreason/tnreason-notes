\begin{tikzpicture}[scale=0.3, thick, yscale=-1] % , baseline = -3.5pt


\draw[<-] (0,-1)--(0,1.5) node[below] {$\atomlegindexof{a}$}; 
\draw[<-] (1.5,-1)--(1.5,1.5) node[below] {$\atomlegindexof{b}$}; 
\draw[<-] (3,-1)--(3,1.5) node[below] {$\atomlegindexof{c}$}; 
...
\draw[->] (0,1)--(0,-1);%  node[midway,left] {$\atomlegindexof{a}$}; 
\draw (0,0.5)--(0,1.5) node[below] {$\atomlegindexof{a}$}; 
...
\draw[->]  (3,1)--(3,-1);% node[midway,right] {$\atomlegindexof{b}$}; 
\draw (3,0.5)--(3,1.5) node[below] {$\atomlegindexof{b}$}; 
...
\draw[->] (6,1)--(6,-1); % node[midway,right] {$\atomlegindexof{c}$}; 
\draw (6,0.5)--(6,1.5) node[below] {$\atomlegindexof{c}$}; 
...
\draw[->] (1.5,-3) --(1.5,-6) node[midway,right]{$\atomlegindexof{a \lor b}$};
...
\draw[->] (6,-3) --(6,-6) node[midway,left]{$\atomlegindexof{\lnot c}$};
...
\draw[->] (4,-8) -- (4,-11) node[midway,right] {$\atomlegindexof{a \lor b \lor \lnot c}$};
