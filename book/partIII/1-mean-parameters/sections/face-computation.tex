\section{Face Computation}

\todo{
    We take the perspective of computation whether a vertex is in a face.
    Based on this perspective, we derive activation tensors to faces.
%%
    Note, that we construct face activation tensors based on DFA computations here.
Thus the decomposition studies of the circuits and automata chapter are relevant.}

\subsection{Examples}

%% Building on the rank 2 example in maxent!
\input{examples/face-computation/tt-diagonal-higher-face}
\input{examples/face-computation/ht-diagonal-face}
