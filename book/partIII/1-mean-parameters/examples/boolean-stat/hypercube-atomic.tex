\begin{example}[Atomic formulas]
    ...
    Let us consider the case of atomic formulas $\formulaofat{\selindex}{\shortcatvariables}$ defined with the coordinates at $\shortcatindicesin$ by
    \begin{align*}
    ...
    More generally, the mean polytope to a collection $\formulaofat{\selindex}{\shortcatvariables}$ of propositional formulas is the hypercube, if and only if for any Boolean vector $\imelementwith$ we have
    \begin{align*}
