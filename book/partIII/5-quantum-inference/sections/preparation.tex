...
\begin{figure}[t]
    \begin{center}
        \input{tikz/rejection-sampling/can_elementary_augmentation}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/rejection-sampling/can_TT_augmentation}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{tikz/rejection-sampling/ca_circuit}
    \end{center}
    \caption{
...
\input{examples/rejection-sampling/toy_accounting_circuit}