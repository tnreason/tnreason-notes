...
\abstract{
    We introduce the notation used in this book.
}
...
%\section{Continuous Variables} % Needed for families of distributions
...
\begin{example}[Delta tensor]
    \label{exa:diracDelta}
...
\section{Tensor networks and contractions}
...
\begin{center}
    \input{preliminaries/notation/tikz-pics/hypercore}
\end{center}
...
\input{preliminaries/notation/examples/cp_format.tex}

\input{preliminaries/notation/examples/tt_format.tex}

\section{Generic contractions}
...
\begin{figure}
    \begin{center}
        \input{preliminaries/notation/tikz-pics/contraction.tex}
    \end{center}
    \caption{
...
\input{preliminaries/notation/examples/tensor_product.tex}
...
\begin{center}
    \input{preliminaries/notation/tikz-pics/directed_core.tex}
\end{center}

\section{Function encoding and \ComputationActivationNetworks{}}
...
\begin{center}
    \input{preliminaries/notation/tikz-pics/bencoding}
\end{center}
