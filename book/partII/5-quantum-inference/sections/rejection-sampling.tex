...
\begin{figure}[t]
    \begin{center}
        \input{partII/5-quantum-inference/tikz/rejection-sampling/can_elementary_augmentation}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partII/5-quantum-inference/tikz/rejection-sampling/can_TT_augmentation}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{partII/5-quantum-inference/tikz/rejection-sampling/ca_circuit}
    \end{center}
    \caption{
...
\input{partII/5-quantum-inference/examples/rejection-sampling/toy_accounting_circuit}
