...
\begin{figure}[t]
    \begin{center}
        \input{tikz/grover-operator/rotation_sketch.tikz}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/grover-operator/reflection-z-realization}
    \end{center}
    \caption{
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/grover-operator/reflection-cc-realization}
    \end{center}
    \caption{
