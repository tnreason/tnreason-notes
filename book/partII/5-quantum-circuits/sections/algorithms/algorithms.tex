...
\todo{Grover and Quantum Phase Estimation here.}

\subsection{Quantum Phase Estimation}\label{sec:quantumPhaseEstimation}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/rotation_sketch.tikz}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/reflection-z-realization}
    \end{center}
    \caption{
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/reflection-cc-realization}
    \end{center}
    \caption{
