...
\input{partI/4-causality/examples/patient_treatment_outcome}
...
\input{partI/4-causality/examples/randomized_controlled_trial}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/4-causality/tikz_pics/backdoor_criterion}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/4-causality/tikz_pics/frontdoor_criterion}
    \end{center}
