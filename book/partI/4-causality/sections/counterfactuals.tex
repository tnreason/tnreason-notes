...
\input{examples/counterfactuals/patient_counterfactual}
...
\begin{figure}[t]
    \input{tikz/counterfactuals/response_variable}
...
\input{examples/counterfactuals/random-walk-response-variables}
...
\begin{figure}[t]
    \input{tikz/counterfactuals/counterfactual_twinned_network}
...
\input{examples/counterfactuals/random-walk-counterfactual-network}