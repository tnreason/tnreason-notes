...
\input{partI/4-causality/examples/patient_counterfactual}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/4-causality/tikz_pics/response_variable}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/4-causality/tikz_pics/counterfactual_twinned_network}
    \end{center}
