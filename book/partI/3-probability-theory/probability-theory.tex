\chapter{Probability Theory}\label{cha:probabilityTheory}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/probability_tensor.tex}
    \end{center}
...
\begin{center}
    \input{tikz-pics/marginalized_probability.tex}
\end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/ones_property_cond.tex}
    \end{center}
...
\begin{center}
    \input{tikz-pics/conditional_probability.tex}
\end{center}
...
\begin{proof}
    ...
    \begin{center}
        \input{tikz-pics/proof_cond_normed.tex}
    \end{center}
...
\begin{center}
    \input{tikz-pics/independent_decomposition.tex}
\end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/cond_independence_decomposition.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/markov_chain.tex}
    \end{center}
...
\input{examples/coin_toss_hc}

\input{examples/student_hc}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/bayesian_factor.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz-pics/hidden_markov_model.tex}
    \end{center}
...
\begin{theorem}[Fisher-Neyman Factorization Theorem] % See appendix of CompAct Nets paper!
    ...
    \begin{center}
        \input{tikz-pics/computation_decomposition.tikz}
    \end{center}
\end{theorem}
\begin{proof}
...
\input{examples/coin_toss_fn}

\input{examples/graphical_models_as_cans}
