...
\begin{figure}[t]
    ...
    \end{center}
    \caption{
        Hypergraph a) capturing the conditional independencies of the student example.
        The cliques of the node adjacency graph are highlighted in b) and coincide with hyperedges of the hypergraph.
