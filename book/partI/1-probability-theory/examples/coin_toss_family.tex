\begin{example}[Family of independent coin tosses]
    ...
    \end{align*}
    Note that by the binomial theorem we have $\contraction{\probat{\shortcatvariables,\thirdcatvariable=\thirdcatindex}} =1$ for each slice with respect to $\thirdcatindex\in[0,1]$. Therefore, $\probat{\shortcatvariables,\thirdcatvariable}$ is indeed a family of probability distributions.
