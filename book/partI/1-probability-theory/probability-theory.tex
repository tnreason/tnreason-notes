...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/probability_tensor.tex}
    \end{center}
...
\begin{center}
    \input{partI/1-probability-theory/tikz-pics/marginalized_probability.tex}
\end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/ones_property_cond.tex}
    \end{center}
...
\begin{center}
    \input{partI/1-probability-theory/tikz-pics/conditional_probability.tex}
\end{center}
...
\begin{proof}
    ...
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/proof_cond_normed.tex}
    \end{center}
...
\begin{center}
    \input{partI/1-probability-theory/tikz-pics/independent_decomposition.tex}
\end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/cond_independence_decomposition.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/markov_chain.tex}
    \end{center}
...
\input{partI/1-probability-theory/examples/coin_toss_hc}

\input{partI/1-probability-theory/examples/student_hc}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/bayesian_factor.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/hidden_markov_model.tex}
    \end{center}
...
\input{partI/1-probability-theory/examples/sufstat_probability}
...
\begin{theorem}[Fisher-Neyman Factorization Theorem] % See appendix of CompAct Nets paper!
    ...
    \begin{center}
        \input{partI/1-probability-theory/tikz-pics/computation_decomposition.tikz}
    \end{center}
\end{theorem}
\begin{proof}
...
\input{partI/1-probability-theory/examples/coin_toss_fn}

\input{partI/1-probability-theory/examples/graphical_models_as_cans}
...
\input{partI/1-probability-theory/examples/student_bp}


%% Further sections from prob reasoning
\input{partI/1-probability-theory/sections/queries}
\input{partI/1-probability-theory/sections/sampling}
\input{partI/1-probability-theory/sections/max-likelihood}