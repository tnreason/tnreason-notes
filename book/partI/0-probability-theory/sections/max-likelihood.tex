...
\begin{figure}[t]
    \begin{center}
        \input{partI/0-probability-theory/tikz-pics/data_decomposition.tex}
    \end{center}
    \caption{
...
\begin{theorem}
    ...
    \begin{center}
        \input{partI/0-probability-theory/tikz-pics/empirical_distribution.tex}
    \end{center}
\end{theorem}
\begin{proof}
...
\begin{definition}[Shannon entropy]
    ...
    \begin{center}
        \input{partI/0-probability-theory/tikz-pics/shannon_entropy.tex}
    \end{center}
...
\begin{definition}[Cross entropy and Kullback Leibler divergence]
    ...
    \begin{center}
        \input{partI/0-probability-theory/tikz-pics/cross_entropy.tex}
    \end{center}
