...
The epistemological commitments of propositional logics are whether the state is $\truesymbol$ or $\falsesymbol$ reflected by coordinates $1$ or $0$.
Intuitively these maps mark, whether a specific world can be the state of a factored system.
...
Review the notation:
\begin{itemize}
    \item $\kb$ as a set of formulas, i.e. a tensor network
    \item $\kbwith$ as the contraction of the tensor network
\end{itemize}
}
