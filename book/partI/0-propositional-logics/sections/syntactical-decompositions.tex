...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz/formula_bencoding.tex}
    \end{center}
...
\begin{lemma}
    ...
    \begin{center}
        \input{./partI/0-propositional-logics/tikz/atomic_ft.tex}
    \end{center}
\end{lemma}
\begin{proof}
...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz/unary_binary_composition.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz/decomposition_example.tex}
    \end{center}
...
\todo{Use the $\hardparam$ parametrization instead of the nodes 0 1 parametrization.}
