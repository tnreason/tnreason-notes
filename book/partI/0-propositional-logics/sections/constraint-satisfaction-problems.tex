...
\begin{definition}\label{def:csp}
    ...
    \end{align*}
    We then call $\extnet$ a constraint tensor network and the tensor
    \begin{align*}
        \extnetat{\nodevariables}
...
\input{partI/0-propositional-logics/examples/constraint-satisfaction-problems/kb-as-csp}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/0-propositional-logics/tikz/constraint-satisfaction-problems/categorical-decomposition.tex}
    \end{center}
