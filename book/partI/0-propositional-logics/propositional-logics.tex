...
\begin{center}
    \input{./partI/0-propositional-logics/tikz-pics/formula_direct.tex}
\end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz-pics/formula_bencoding.tex}
    \end{center}
...
\begin{lemma}
    ...
    \begin{center}
        \input{./partI/0-propositional-logics/tikz-pics/atomic_ft.tex}
    \end{center}
\end{lemma}
\begin{proof}
...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz-pics/unary_binary_composition.tex}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{./partI/0-propositional-logics/tikz-pics/decomposition_example.tex}
    \end{center}
