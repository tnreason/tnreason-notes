...
\begin{itemize}
    ...
    \begin{align*}
        T_{\insymbol \rightarrow \outsymbol}[\ccatvariable{\insymbol},\ccatvariable{\outsymbol}] : \bigotimes_{\atomenumerator\in\variablesetof{\insymbol}} \mathbb{C}^2 \rightarrow \bigotimes_{\atomenumerator\in\variablesetof{\outsymbol}} \mathbb{C}^2  \, ,
    \end{align*}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/circuit_notation/directed_measurement_sketch.tikz}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/circuit_notation/phase_contraction_measurement.tikz}
    \end{center}
