...
\begin{figure}[t]
    \begin{center}
        \input{tikz/computation-circuits/bencoding_computation_circuit}
    \end{center}
...
\begin{figure}[t]
    \begin{center}
        \input{tikz/computation-circuits/mod2_sum_computation_circuit}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{tikz/computation-circuits/slice_computation_circuit}
    \end{center}
    \caption{
...
\begin{figure}
    \begin{center}
        \input{tikz/computation-circuits/proof_decomposition_sparsity}
    \end{center}
    \caption{
