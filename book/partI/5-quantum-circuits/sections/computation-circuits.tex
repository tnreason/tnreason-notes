...
We here suggest a quantum pendant to basis encodings, which has the decomposition by contraction property.
...
\input{partI/5-quantum-circuits/examples/computation-circuits/cnot-benc}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/computation-circuits/bencoding_computation_circuit}
    \end{center}
...
% Good place?
\input{partI/5-quantum-circuits/examples/computation-circuits/mcnot-benc}

\subsection{\PolynomialSparsity{}}
...
\begin{figure}[t]
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/computation-circuits/mod2_sum_computation_circuit}
    \end{center}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/computation-circuits/slice_computation_circuit}
    \end{center}
    \caption{
...
\subsection{\DecompositionSparsity{}}
...
%\begin{figure}
%    \begin{center}
%        \input{partI/5-quantum-circuits/tikz/computation-circuits/decomposition_sparsity}
%    \end{center}
%    \caption{
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/computation-circuits/proof_decomposition_sparsity}
    \end{center}
    \caption{
...
\input{partI/5-quantum-circuits/examples/computation-circuits/mcnot-decomposition}
