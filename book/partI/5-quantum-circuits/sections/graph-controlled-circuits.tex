...
\subsection{Preparation of q-samples to Bayesian Networks} % Former activation circuits

\red{Here: Bayesian networks with boolean variables}

\subsubsection{\ActivationCircuits{}}

We now study circuits preparing q-samples of Bayesian Networks.
...
\subsubsection{Q-samples of Bayesian Networks}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/directed_to_circuit.tex}
    \end{center}
    \caption{
...
\input{partI/5-quantum-circuits/examples/graph-controlled-circuits/grover-rudolph}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/graph-controlled-circuits/ancilla_augmentation}
    \end{center}
    \caption{
...
\begin{center}
    \input{partI/5-quantum-circuits/tikz/graph-controlled-circuits/activation_ancilla_preparation}
\end{center}
...
\input{partI/5-quantum-circuits/examples/graph-controlled-circuits/elementary_tensors}
...
\begin{figure}
    \begin{center}
        \input{partI/5-quantum-circuits/tikz/graph-controlled-circuits/markov_network_augmentation}
    \end{center}
