...
\begin{figure}
    \begin{center}
        \input{tikz/directed_to_circuit.tex}
    \end{center}
    \caption{
...
\begin{figure}
    \begin{center}
        \input{tikz/graph-controlled-circuits/ancilla_augmentation}
    \end{center}
    \caption{
...
\begin{center}
    \input{tikz/graph-controlled-circuits/activation_ancilla_preparation}
\end{center}
...
\begin{figure}
    \begin{center}
        \input{tikz/graph-controlled-circuits/markov_network_augmentation}
    \end{center}
